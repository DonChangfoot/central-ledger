...
function installAll() {
    return __awaiter(this, void 0, void 0, function* () {
        for (const v of definitelytyped_header_parser_1.TypeScriptVersion.supported) {
            // manually install typescript@next outside the loop
            if (v === definitelytyped_header_parser_1.TypeScriptVersion.supported[definitelytyped_header_parser_1.TypeScriptVersion.supported.length - 1]) {
                continue;
            }
            yield install(v);
        }
