...
function testTypesVersion(dirPath, lowVersion, maxVersion, isOlderVersion, dt, indexText, expectOnly, tsLocal, inTypesVersionDirectory) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const minVersion = lowVersion
            || minVersionFromComment && definitelytyped_header_parser_1.TypeScriptVersion.isSupported(minVersionFromComment) && minVersionFromComment
            || definitelytyped_header_parser_1.TypeScriptVersion.lowest;
